            ...
            <div class="col-md-12 col-lg-10">
                ...
                @if(!empty($data["showResult"]))
                    @php
                        ...
                        $result_data = array();
                        $result_data = $lab2->expected_value_dispersion_calculate($lab2->dmt_spreadsheet, $data["c1"], $data["c2"], $data["n"]);
                    @endphp
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    <th scope="col">T</th>
                                    <th scope="col">p<sub>t</sub></th>
                                    <th scope="col">p<sub>t</sub><sup>2</sup></th>
                                    <th scope="col">&sum;<sub>t=1</sub><sup>T-1</sup>p<sub>t</sub></th>
                                    <th scope="col">&sum;<sub>t=1</sub><sup>T-1</sup>p<sub>t</sub><sup>2</sup></th>
                                    <th scope="col">M(B(T))+D(B(T))</th>
                                </tr>
                                </thead>
                                <tbody>
...
{{--                            <p class="card-text">Значення: {{$result_data["val"]}}</p>--}}
                            <h5 class="card-text"><b>Альтернатива: T{{$result_data["number_of_row_of_alternative"] + 1}}</b></h5>
                        </div>
                    </div>
                @endif
            </div>
